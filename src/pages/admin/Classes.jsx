    ...
    <div>
      <div className="flex justify-start items-center mb-4">
        ...
        <div class="ml-4 relative w-1/2">
          <input
            type="search"
            id="search-dropdown"
            class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-lg dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white"
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        <table className="table-auto w-full border-collapse overflow-hidden rounded-lg">
          ...
          <tbody>
            {classes.map((classes) => (
              <tr key={classes.id} className="border-b hover:bg-gray-50">
                <td className="p-3 text-center">{classes.code}</td>
                <td className="p-3">{classes.class}</td>
