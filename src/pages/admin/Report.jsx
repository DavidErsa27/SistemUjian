  ...
  const [reports, setReports] = useState([
    {
      ...
      subject: "Praktikum Pemrograman Berorientasi Objek",
    },
    {
      id: 2,
      exam: "Ujian Tengah Semester (UTS)",
            ...
            <tr className="flex justify-between items-end gap-4">
              <td className="w-full">
                ...
                >
                  ...
                  <option value="UTS">UTS Praktikum Pemrograman Berorientasi Objek</option>
                  <option value="UAS">UTS Pemrograman Berorientasi Objek</option>
                  <option value="Kuis">UAS Sistem Pendukung Keputusan</option>
                </select>
              </td>
              <td className="w-1/2">
                <button
