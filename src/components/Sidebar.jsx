...
const Sidebar = () => {
  return (
    <aside className="w-64 bg-blue-600 text-white flex flex-col h-screen fixed">
      ...
      <nav className="flex-1">
        <ul className="mx-6">
          <div className="border-y border-white">
            <a href="/">
              <li className="flex items-center p-2 my-3 rounded-lg hover:bg-blue-500 cursor-pointer">
                <FontAwesomeIcon
                  icon={faTachometer}
                  color="white"
                  className="mr-2"
